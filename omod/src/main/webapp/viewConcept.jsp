...
<openmrs:require privilege="View Concept Classes" otherwise="/login.htm"
	redirect="/module/conceptsearch/viewConcept.form" />
...
<h2>
	<spring:message code="conceptsearch.viewconcept" />
</h2>
<br />
<h3>
	<spring:message code="conceptsearch.viewingconcept" />
	${concept.name} (${concept.conceptId})
</h3>

<div id="conceptTabs">
	<ul>
		<li><a id="conceptOverviewTab" href="#"
			onclick="return changeTab(this);" hidefocus="hidefocus">Overview</a></li>

		<li><a id="conceptDetailsTab" href="#"
			onclick="return changeTab(this);" hidefocus="hidefocus">Details</a></li>

		<li><a id="conceptMetadataTab" href="#"
			onclick="return changeTab(this);" hidefocus="hidefocus">Metadata</a></li>
	</ul>
</div>

<div id="conceptOverview" style="display: none;">
	<div class="boxHeader">
		<spring:message code="conceptsearch.overview" />
	</div>
	<div class="box">
		<table>
			<tr>
...
<div id="conceptDetails" style="display: none;">
	<div class="boxHeader">
		<spring:message code="conceptsearch.details" />
	</div>
	<div class="box">
		<table>
			<tr>
			...
			<tr>
				...
				<td>${concept.retired} <c:if test="${concept.retired==true}">
						<spring:message code="conceptsearch.on" />
						<openmrs:formatDate date="${concept.dateRetired}" type="short" />
						<spring:message code="conceptsearch.by" /> ${concept.retiredBy.personName}: ${concept.retireReason}</c:if></td>
			</tr>
			<tr>
			...
			<c:forEach var="set" items="${concept.conceptSets}">
				<tr>
					<td></td>
					<td><a href="?conceptId=${set.conceptSet.conceptId}">${set.conceptSet.name}</a>
						parent of <a href="?conceptId=${set.concept.conceptId}">${set.concept.name}</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
...
<div id="conceptMetadata" style="display: none;">
	<div class="boxHeader">
		<spring:message code="conceptsearch.metadata" />
	</div>
	<div class="box">
		<table>
			<tr>
			...
			<tr>
				...
				<td><spring:message code="conceptsearch.createdon" /> <openmrs:formatDate
						date="${concept.dateCreated}" type="short" /> <spring:message
						code="conceptsearch.by" /> ${concept.creator.personName} (id:
					${concept.creator.userId})</td>
			</tr>
			<tr>
				<td><b><spring:message code="conceptsearch.changed" /></b></td>
				<td><spring:message code="conceptsearch.changedon" /> <openmrs:formatDate
						date="${concept.dateChanged}" type="short" /> <spring:message
						code="conceptsearch.by" /> ${concept.creator.personName} (id:
					${concept.creator.userId})</td>
			</tr>
		</table>
