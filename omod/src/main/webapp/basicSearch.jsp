...
<openmrs:require privilege="View Concept Classes" otherwise="/login.htm"
	redirect="/module/conceptsearch/basicSearch.form" />
...
<h2>
	<spring:message code="conceptsearch.basicheading" />
</h2>
<br />
		...
		<table>
			<tr>
				<td><input id="conceptQuery" type="text" name="conceptQuery"
					size="25" value="${conceptSearch.searchQuery}"> <script>
			$("#conceptQuery").autocomplete("<%=request.getContextPath()%>
				...
				<td><input type="submit"
					...
					href="advancedSearch.form"><spring:message
							code="conceptsearch.advancedheading" /></a></td>
			</tr>
		</table>
	</div>
</form>
